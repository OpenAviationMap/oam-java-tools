...
public class RenderException extends Exception {
     ...
     */
    public RenderException(String desc) {
        super(desc);
    }
     ...
     * @param cause the original cause of the issue.
     */
    public RenderException(String desc, Throwable cause) {
        super(desc, cause);
    }
     ...
     * @param desc the description of the issue.
     */
    public RenderException(String    designator,
                          String    desc) {
        super(desc);
     ...
     * @param desc the description of the issue.
     */
    public RenderException(Node      node,
                          String    desc) {
        super(desc);
