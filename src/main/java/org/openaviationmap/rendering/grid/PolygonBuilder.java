 ...
 * 
 * @see org.openaviationmap.rendering.grid.hexagon.HexagonGridBuilder
 * @see org.openaviationmap.rendering.grid.oblong.OblongGridBuilder
 *
 * @author mbedward
 * @since 8.0
 *
...
public abstract class PolygonBuilder {
    ...
    private static final Logger LOGGER = Logger.getLogger("org.openaviationmap.rendering.grid");
