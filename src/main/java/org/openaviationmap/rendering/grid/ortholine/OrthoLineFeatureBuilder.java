...
package org.openaviationmap.rendering.grid.ortholine;

import org.openaviationmap.rendering.grid.GridElement;
import org.openaviationmap.rendering.grid.GridFeatureBuilder;
...
public class OrthoLineFeatureBuilder extends GridFeatureBuilder {
    ...
    /**
     * Name of the Integer level attribute ("subscale")
     */
    public static final String SUBSCALE_ATTRIBUTE_NAME = "subscale";
    ...
    protected static SimpleFeatureType createType(String typeName, CoordinateReferenceSystem crs) {
        ...
        tb.add(SUBSCALE_ATTRIBUTE_NAME, Integer.class);
    ...
    /**
     * Sets the following attributes for a subscale in the provided {@code Map}:
     * <ul>
     * <li>id: sequential integer</li>
     * <li>subscale: integer level of associated with the element</li>
     * <li>value: X-ordinate for a vertical line; Y-ordinate for a horizontal line</li>
     * </ul>
     *
     * @param el the element from which the new feature is being constructed
     * @param attributes a {@code Map} into which the attributes will be put
     */
    public void setAttributesSubscale(GridElement el,
                                      Map<String, Object> attributes) {
        if (el instanceof OrthoLine) {
            OrthoLine orthoLine = (OrthoLine) el;
            attributes.put(ID_ATTRIBUTE_NAME, ++id);
            attributes.put(SUBSCALE_ATTRIBUTE_NAME, orthoLine.getLevel());
